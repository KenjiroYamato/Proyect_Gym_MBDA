CREATE PACKAGE BODY ADMINISTRACION.PKG_ADMINISTRACION AS
    -- CRUD ZONAS
    ...
    FUNCTION ADMINISTRACION.OBTENER_ZONAS RETURN SYS_REFCURSOR IS
    ...
    FUNCTION ADMINISTRACION.OBTENER_ZONA(P_NOMBRE IN VARCHAR2) RETURN SYS_REFCURSOR IS
    ...
    FUNCTION ADMINISTRACION.OBTENER_ZONAS_SEDE(P_SEDE IN NUMBER) RETURN SYS_REFCURSOR IS
        ZONAS_CURSOR SYS_REFCURSOR;
    BEGIN
        OPEN ZONAS_CURSOR FOR
    ...
    PROCEDURE ADMINISTRACION.ELIMINAR_ZONA(P_NOMBRE IN VARCHAR2, P_SEDE IN NUMBER) IS
    BEGIN
    ...
    FUNCTION ADMINISTRACION.OBTENER_SOLICITUDES RETURN SYS_REFCURSOR IS
    ...
    FUNCTION ADMINISTRACION.OBTENER_SOLICITUD(P_ID IN NUMBER) RETURN SYS_REFCURSOR IS
    ...
    FUNCTION ADMINISTRACION.OBTENER_SOLICITUDES_CREADOR(P_CREADOR IN NUMBER) RETURN SYS_REFCURSOR IS
        SOLICITUDES_CURSOR SYS_REFCURSOR;
    BEGIN
        OPEN SOLICITUDES_CURSOR FOR
    ...
    FUNCTION ADMINISTRACION.OBTENER_INVENTARIO_SEDE(P_SEDE IN NUMBER) RETURN SYS_REFCURSOR IS
    ...
    PROCEDURE ADMINISTRACION.ELIMINAR_INVENTARIO(P_ID IN NUMBER) IS
    BEGIN
    ...
    FUNCTION ADMINISTRACION.OBTENER_MAQUINAS_SEDE(P_SEDE IN NUMBER) RETURN SYS_REFCURSOR IS
    ...
    FUNCTION ADMINISTRACION.OBTENER_MAQUINA(P_ID IN NUMBER) RETURN SYS_REFCURSOR IS
    ...
    PROCEDURE ADMINISTRACION.ELIMINAR_MAQUINA(P_ID IN NUMBER) IS
    BEGIN
    ...
    FUNCTION ADMINISTRACION.OBTENER_ELEMENTOS_SEDE(P_SEDE IN NUMBER) RETURN SYS_REFCURSOR IS
    ...
    FUNCTION ADMINISTRACION.OBTENER_ELEMENTO(P_ID IN NUMBER) RETURN SYS_REFCURSOR IS
    ...
    PROCEDURE ADMINISTRACION.ELIMINAR_ELEMENTO(P_ID IN NUMBER) IS
    BEGIN
    ...
    FUNCTION ADMINISTRACION.OBTENER_ENTRADAS_SALIDAS RETURN SYS_REFCURSOR IS
    ...
    FUNCTION ADMINISTRACION.OBTENER_ENTRADAS_SALIDAS_PERSONA(P_PERSONA IN NUMBER) RETURN SYS_REFCURSOR IS
        ENTRADAS_SALIDAS_CURSOR SYS_REFCURSOR;
    BEGIN
        OPEN ENTRADAS_SALIDAS_CURSOR FOR
    ...
    FUNCTION ADMINISTRACION.OBTENER_ENTRADAS_SALIDAS_ZONA(P_ZONA IN VARCHAR2) RETURN SYS_REFCURSOR IS
        ENTRADAS_SALIDAS_CURSOR SYS_REFCURSOR;
    BEGIN
        OPEN ENTRADAS_SALIDAS_CURSOR FOR
    ...
    FUNCTION ADMINISTRACION.OBTENER_EVENTOS RETURN SYS_REFCURSOR IS
    ...
    FUNCTION ADMINISTRACION.OBTENER_EVENTO(P_ID IN NUMBER) RETURN SYS_REFCURSOR IS
    ...
    FUNCTION ADMINISTRACION.OBTENER_EVENTOS_SEDE(P_SEDE IN NUMBER) RETURN SYS_REFCURSOR IS
        EVENTOS_CURSOR SYS_REFCURSOR;
    BEGIN
        OPEN EVENTOS_CURSOR FOR
    ...
    FUNCTION ADMINISTRACION.OBTENER_ASISTENTES_EVENTO(P_EVENTO IN NUMBER) RETURN SYS_REFCURSOR IS
    ...
    -- R [READ] CONTRATOS
    FUNCTION ADMINISTRACION.OBTENER_CONTRATOS RETURN SYS_REFCURSOR IS
    ...
    FUNCTION ADMINISTRACION.OBTENER_CONTRATO(P_ID IN NUMBER) RETURN SYS_REFCURSOR IS
    ...
    -- R [READ] EMPLEADOS
    FUNCTION ADMINISTRACION.OBTENER_EMPLEADOS_SEDE(P_SEDE IN NUMBER) RETURN SYS_REFCURSOR IS
