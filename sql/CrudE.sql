...
CREATE OR REPLACE PACKAGE PKG_USUARIOS AS
    ...
    PROCEDURE CONSULTAR_USUARIO(P_DOCUMENTO IN NUMBER);
    ...
    PROCEDURE CONSULTAR_CONTROLES(P_USUARIO IN NUMBER);
    ...
    PROCEDURE MEMBRESIA_ACTIVA(P_USUARIO IN NUMBER);
    PROCEDURE ACCESO_ZONA(P_USUARIO IN NUMBER, P_SEDE IN NUMBER, P_ZONA IN VARCHAR2);
END PKG_USUARIOS;
...
CREATE OR REPLACE PACKAGE PKG_EMPLEADOS AS
    ...
    PROCEDURE CONSULTAR_EMPLEADO(P_DOCUMENTO IN NUMBER);
    PROCEDURE ELIMINAR_EMPLEADO(P_DOCUMENTO IN NUMBER);
    PROCEDURE CONSULTAR_EMPLEADOS;

    PROCEDURE CONSULTAR_CONTRATO(P_ID IN NUMBER);
    ...
    PROCEDURE CONSULTAR_SOLICITUD(P_ID IN NUMBER);
    PROCEDURE CONSULTAR_SOLICITUDES_EMPLEADO(P_EMPLEADO IN NUMBER);
    ...
    PROCEDURE CONSULTAR_EVENTO(P_ID IN NUMBER);
    PROCEDURE CONSULTAR_EVENTOS;
    PROCEDURE CONSULTAR_EVENTOS_EMPLEADO(P_EMPLEADO IN NUMBER);
END PKG_EMPLEADOS;
...
CREATE OR REPLACE PACKAGE PKG_SEDES AS
    ...
    PROCEDURE CONSULTAR_SEDE(P_ID IN NUMBER);
    PROCEDURE CONSULTAR_SEDES;
    ...
    PROCEDURE CONSULTAR_ZONAS(P_SEDE IN NUMBER);
    PROCEDURE ELIMINAR_ZONA(P_NOMBRE IN VARCHAR2, P_SEDE IN NUMBER);

    PROCEDURE CREAR_REGISTRO_ELEMENTO(
        P_ID          IN NUMBER,
        P_SEDE        IN NUMBER,
        P_NOMBRE      IN VARCHAR2,
        P_PRECIO      IN NUMBER,
...
CREATE OR REPLACE PACKAGE PKG_MEMBRESIA AS
    ...
    PROCEDURE CONSULTAR_TIPOS_MEMBRESIA;
    ...
    PROCEDURE CONSULTAR_BENEFICIO_ZONA(
        P_TIPO_MEMBRESIA IN VARCHAR2
    );
...
CREATE OR REPLACE PACKAGE PKG_ENTRADASALIDAS AS
    ...
    PROCEDURE CONSULTAR_ENTRADAS(
        P_PERSONA IN NUMBER
    );
    PROCEDURE CONSULTAR_SALIDAS(
        P_PERSONA IN NUMBER
    );
