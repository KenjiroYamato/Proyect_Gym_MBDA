...
CREATE SEQUENCE SEQ_UID_CONTRATOS
    START WITH 9000
    INCREMENT BY 1
    NOCACHE
    NOCYCLE;
...
CREATE OR REPLACE TRIGGER TGR_BEFORE_INSERT_CONTRATO
    ...
    FOR EACH ROW
BEGIN
    SELECT SEQ_UID_CONTRATOS.nextval INTO :NEW.ID FROM DUAL;
end;


CREATE SEQUENCE SEQ_UID_LUGARES
    START WITH 0
    INCREMENT BY 1
    NOCACHE
    NOCYCLE;
...
CREATE OR REPLACE TRIGGER TGR_BEFORE_INSERT_LUGARES
    ...
    FOR EACH ROW
BEGIN
    SELECT SEQ_UID_LUGARES.nextval INTO :NEW.ID FROM DUAL;
end;

CREATE SEQUENCE SEQ_UID_ENTRADA_SALIDA
    START WITH 0
    INCREMENT BY 1
    NOCACHE
    NOCYCLE;
...
CREATE OR REPLACE TRIGGER TGR_BEFORE_INSERT_REG_ENTRADA_SALIDA
    BEFORE INSERT ON REGISTROENTRADASALIDAS
    FOR EACH ROW
BEGIN
    SELECT SEQ_UID_ENTRADA_SALIDA.nextval INTO :NEW.ID FROM DUAL;
end;