...
CREATE SEQUENCE Administracion.SEQ_UID_SOLICITUDES
    START WITH 0
    INCREMENT BY 1
    MINVALUE 0
    NOCACHE
...
CREATE OR REPLACE TRIGGER TGR_BEFORE_INSERT_SOLICITUDES
    BEFORE INSERT ON Administracion.SOLICITUDES
    FOR EACH ROW
BEGIN
    SELECT Administracion.SEQ_UID_SOLICITUDES.nextval INTO :NEW.ID FROM DUAL;
end;

CREATE SEQUENCE Administracion.SEQ_UID_INVENTARIO
    START WITH 0
    INCREMENT BY 1
    MINVALUE 0
    NOCACHE
...
CREATE OR REPLACE TRIGGER TGR_BEFORE_INSERT_INVENTARIO
    BEFORE INSERT ON Administracion.INVENTARIO
    FOR EACH ROW
BEGIN
    SELECT Administracion.SEQ_UID_INVENTARIO.nextval INTO :NEW.ID FROM DUAL;
end;