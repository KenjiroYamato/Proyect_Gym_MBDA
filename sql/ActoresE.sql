...
CREATE OR REPLACE PACKAGE GERENCIA.PKG_GERENCIA AS
    ...
    -- CRUD SEDES
    PROCEDURE GERENCIA.REGISTRAR_SEDE(
        P_ID          IN NUMBER,
        P_NOMBRE      IN VARCHAR2,
        P_LUGAR       IN NUMBER
    );

    FUNCTION GERENCIA.OBTENER_SEDES RETURN SYS_REFCURSOR;
    FUNCTION GERENCIA.OBTENER_SEDE(P_ID IN NUMBER) RETURN SYS_REFCURSOR;

    PROCEDURE GERENCIA.ACTUALIZAR_SEDE(
        P_ID          IN NUMBER,
        P_NOMBRE      IN VARCHAR2
    );

    PROCEDURE GERENCIA.ELIMINAR_SEDE(P_ID IN NUMBER);
